        ...
        <>
            { live ? (
                <div className="card card_border">
                    <svg className="card__star" width="182" height="164" viewBox="0 0 182 164" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a className="card__link" href="https://www.twitch.tv/">
                        ...
                        <h6 className="card__link_text">WATCH LIVE!</h6>
                    </a>
                    <h5 className="card__title">Asia Minor: Play-Off</h5>
                    <div className="teams">
                        <div className="teams__logo">
                            <img className="logo" src={firstTeamLogo} alt="Team Logo"/>
                            <img className="logo" src={secondTeamLogo} alt="Team Logo"/>
                        </div>
                        <div className="teams__info">
                            <div className="teams__info_name">{firstTeam}</div>
                            <div className="teams__info_coeff">3.22</div>
                        </div>
                        <div className="teams__info">
                            <div className="teams__info_name">{secondTeam}</div>
                            <div className="teams__info_coeff">53.22</div>
                        </div>
                    </div>
                    <div className="match">
                        <div className="match__info">Bо 3</div>
                        <div className="match__sponsor"></div>
                    </div>
                </div>)
                : upcoming ? (
                    <div className="card">
                        ...
                        <h5 className="card__time">19:00</h5>
                        <h6 className="card__date">29 октября</h6>
                        <h5 className="card__title">Asia Minor: Play-Off</h5>
                        <div className="teams">
                            <div className="teams__logo">
                                <img className="logo" src={firstTeamLogo} alt="Team Logo"/>
                        ...
                        <div className="match">
                            <div className="match__info">Starts in: 5 hours 39 min • Bо 3</div>
                            <div className="match__sponsor"></div>
                        </div>
                    </div>
                ) 
                : finished ? (
                    <div className="card">
                        ...
                        <h5 className="card__time finished">19:00</h5>
                        <h6 className="card__date finished">29 октября</h6>
                        <h5 className="card__title">Asia Minor: Play-Off</h5>
                        <div className="teams">
                            <div className="teams__logo">
                                <img className="logo" src={firstTeamLogo} alt="Team Logo"/>
                            ...
                            <div className="teams__info">
                                {looseFirst ? (
                                    <>
                                        <div className="teams__info_name loose">{firstTeam}</div>
                                        <div className="teams__info_score loose">{firstScore}</div>
                                    </>
                                )
                                : (
                                    <>
                                        <div className="teams__info_name">{firstTeam}</div>
                                        <div className="teams__info_score">{firstScore}</div>
                                    </>
                                )}
                            </div>
                            <div className="teams__info">
                                {looseSecond ? (
                                    <>
                                        <div className="teams__info_name loose">{secondTeam}</div>
                                        <div className="teams__info_score loose">{secondScore}</div>
                                    </>
                                )
                                : (
                                    <>
                                        <div className="teams__info_name">{secondTeam}</div>
                                        <div className="teams__info_score">{secondScore}</div>
                                    </>
                                )}
                            </div>
                        </div>
                        <div className="match">
                            <div className="match__info">1:0 • 1:0 • 1:0</div>
                            <div className="match__sponsor"></div>
                        </div>
                    </div>
                ) 
